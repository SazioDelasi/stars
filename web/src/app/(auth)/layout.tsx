  ...
  return (
    <main className="min-h-screen w-full bg-background flex items-center justify-center p-4 md:p-8">
      ...
      <div className="max-w-5xl w-full bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/60 overflow-hidden grid grid-cols-1 md:grid-cols-2">
        ...
        <section className="hidden md:flex flex-col items-center justify-center p-12 bg-login-bg border-r border-slate-100">
          <div className="w-48 h-48 bg-uenr-brown rounded-3xl flex items-center justify-center shadow-2xl mb-8">
            <span className="text-6xl font-black text-white tracking-tighter">S.</span>
          </div>
          <h2 className="text-2xl font-bold text-uenr-brown text-center mb-4">
