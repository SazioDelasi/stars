...
class User(AbstractUser):
    ...
    ROLE_CHOICES = [
        ...
        (ROLE_DEPT_COORDINATOR, 'Departmental Exams Coorzdinator'),
        (ROLE_UNIVERSITY_COORDINATOR, 'University Exams Coordinator'),
    ]
    ...
    @property
    def is_hod(self): return self.role == self.ROLE_HOD

    @property
    def is_dept_coordinator(self): return self.role == self.ROLE_DEPT_COORDINATOR

    @property
    def is_university_coordinator(self): return self.role == self.ROLE_UNIVERSITY_COORDINATOR

    # legacy alias kept for backward compat
    @property
    def is_exams_coordinator(self):
        return self.role in (self.ROLE_DEPT_COORDINATOR, self.ROLE_UNIVERSITY_COORDINATOR)

    @property
    def is_any_staff(self):
        return self.role in (
            self.ROLE_HOD, self.ROLE_DEPT_COORDINATOR, self.ROLE_UNIVERSITY_COORDINATOR
        )
